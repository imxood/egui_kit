use crate::components::list_item::{ContentContext, ListItemContent};

/// Simple [`ListItemContent`] to easily display a button in a [`crate::components::list_item::ListItem`]-based UI.
