...
use crate::extensions::egui_ext::boxed_widget::{BoxedWidgetLocal, BoxedWidgetLocalExt as _};
use crate::components::list_item::{ContentContext, DesiredWidth, ListItemContent};
use crate::extensions::{OnResponseExt as _, UiExt as _};
...
impl<'a> CustomContent<'a> {
    ...
    pub fn action_button(
        self,
        icon: &'static crate::components::basic::icon::Icon,
