...
use crate::{ContextExt as _, DesignTokens, Icon, LabelStyle, components::basic::icon};
...
pub trait UiExt {
    ...
    fn tokens(&self) -> &'static DesignTokens {
        crate::foundation::design_tokens_of(self.theme())
    }
    ...
    /// [`crate::components::list_item::ListItem`].
    ///
    /// Note that `add_contents` is called within a [`crate::components::list_item::list_item_scope`].
    fn list_item_popup<R>(
        ...
        egui::Popup::from_response(widget_response)
            ...
            .show(|ui| {
                ...
                frame.show(ui, |ui| {
                    crate::components::list_item::list_item_scope(ui, popup_id, |ui| {
    ...
    fn re_hyperlink(
        ...
        ui.scope(|ui| {
            ...
            let response = ui
                .add(
                    crate::components::basic::icon::EXTERNAL_LINK
                        .as_button_with_label(tokens, text),
                )
    ...
    fn help_button(&mut self, help_ui: impl FnOnce(&mut egui::Ui)) -> egui::Response {
        ...
        ui.scope(|ui| {
            ...
            let menu_button = egui::containers::menu::MenuButton::from_button(
                ui.small_icon_button_widget(&icon::HELP, "Help"),
            );
    ...
    fn markdown_ui(&mut self, markdown: &str) {
        // Fallback: show as plain text when markdown feature is not enabled
        self.ui_mut().label(markdown);
    }
