...
pub trait ContextExt {
    ...
    fn tokens(&self) -> &'static DesignTokens {
        crate::foundation::design_tokens_of(self.ctx().theme())
    }
    ...
    fn top_bar_style(&self, style_like_web: bool) -> TopBarStyle {
        ...
        let native_buttons_size_in_native_scale = if make_room_for_window_buttons {
            ...
            use crate::extensions::egui_ext::WindowChromeMetrics;
            ...
            if let Some(metrics) = metrics {
                ...
                if cfg!(debug_assertions) {
                    log::warn!("Failed to measure the size of the mac traffic light area");
                }
