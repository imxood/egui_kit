use egui::Ui;
use egui_kit::list_item::ListItemContentButtonsExt as _;
use egui_kit::{UiExt as _, list_item};
            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with icon")
                        .with_icon(&egui_kit::components::basic::icon::VIEW_TEXT),
                );
                ...
                ui.list_item()
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("LabelContent with custom styling")
                            .subdued(true)
                            .italics(true)
                            .with_icon(&egui_kit::components::basic::icon::VIEW_2D),
                    )
                ...
                ui.list_item()
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("LabelContent with LabelStyle")
                            .label_style(egui_kit::LabelStyle::Unnamed)
                            .with_icon(&egui_kit::components::basic::icon::VIEW_2D),
                    )
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with buttons").with_buttons(|ui| {
                        ui.small_icon_button(&egui_kit::components::basic::icon::ADD, "Add");
                        ui.small_icon_button(&egui_kit::components::basic::icon::REMOVE, "Remove");
                    }),
                );
                ...
                list_item::list_item_scope(ui, "inner_scope", |ui| {
                    ...
                    ui.list_item().show_hierarchical(
                        ...
                        list_item::PropertyContent::new("Color")
                            .with_icon(&egui_kit::components::basic::icon::VIEW_TEXT)
                            .with_action_button(&egui_kit::components::basic::icon::ADD, "Add", || {
            ...
            |ui| {
                ...
                list_item::list_item_scope(ui, "inner_scope", |ui| {
                    ...
                    if self.use_action_button {
                        content = content.with_action_button(&egui_kit::components::basic::icon::ADD, "Add", || {
                            log::warn!("Add button clicked");
                        });
                    }
        ...
        ui.list_item().show_hierarchical_with_children(
            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    .action_button(&egui_kit::components::basic::icon::ADD, "Add", || {
                        log::warn!("Add button clicked");
                    }),
                );
            },
