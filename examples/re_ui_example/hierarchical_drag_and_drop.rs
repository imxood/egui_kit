...
use egui_kit::{DesignTokens, UiExt as _, list_item};
...
impl HierarchicalDragAndDrop {
    ...
    fn handle_interaction(
        ...
        let item_desc = egui_kit::drag_and_drop::ItemContext {
            id: item_id,
            item_kind: if is_container {
                egui_kit::drag_and_drop::ItemKind::Container {
                    parent_id,
                    position_index_in_parent,
                }
            } else {
                egui_kit::drag_and_drop::ItemKind::Leaf {
                    parent_id,
                    position_index_in_parent,
                }
            },
        ...
        let drop_target = egui_kit::drag_and_drop::find_drop_target(
            ui,
            &item_desc,
            response.rect,
